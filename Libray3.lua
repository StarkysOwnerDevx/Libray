	...
	Themes = {
		...
		Red = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 25, 25)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30, 20, 20))
			}),
			["Color Hub 2"] = Color3.fromRGB(35, 25, 25),
			["Color Stroke"] = Color3.fromRGB(60, 35, 35),
		...
		Green = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(25, 40, 25)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 30, 20))
			}),
			["Color Hub 2"] = Color3.fromRGB(25, 35, 25),
			["Color Stroke"] = Color3.fromRGB(35, 60, 35),
		...
		Orange = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 25, 15)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(45, 30, 20)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(35, 25, 15))
			}),
			["Color Hub 2"] = Color3.fromRGB(40, 30, 20),
			["Color Stroke"] = Color3.fromRGB(65, 45, 25),
			["Color Theme"] = Color3.fromRGB(255, 140, 0),
			["Color Text"] = Color3.fromRGB(255, 240, 220),
			["Color Dark Text"] = Color3.fromRGB(220, 180, 120)
		},
		Pink = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 20, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(45, 25, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(35, 20, 30))
			}),
			["Color Hub 2"] = Color3.fromRGB(40, 25, 35),
			["Color Stroke"] = Color3.fromRGB(60, 35, 55),
			["Color Theme"] = Color3.fromRGB(255, 100, 200),
			["Color Text"] = Color3.fromRGB(255, 220, 240),
			["Color Dark Text"] = Color3.fromRGB(220, 150, 200)
		},
		Cyan = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 30, 35)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 40, 45)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 30, 35))
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 35, 40),
			["Color Stroke"] = Color3.fromRGB(25, 60, 65),
			["Color Theme"] = Color3.fromRGB(0, 255, 255),
			["Color Text"] = Color3.fromRGB(220, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(150, 220, 220)
		},
		White = {
			["Color Hub 1"] = ColorSequence.new({
		...
		Gold = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 35, 15)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(50, 45, 20)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(40, 35, 15))
			}),
			["Color Hub 2"] = Color3.fromRGB(45, 40, 20),
			["Color Stroke"] = Color3.fromRGB(70, 65, 30),
			["Color Theme"] = Color3.fromRGB(255, 215, 0),
			["Color Text"] = Color3.fromRGB(255, 250, 200),
			["Color Dark Text"] = Color3.fromRGB(220, 200, 100)
		}
	},
	Info = {
		Version = "2.0.0"
...
function redzlib:SetScale(NewScale)
	NewScale = ViewportSize.Y / math.clamp(NewScale, 400, 1200)
	UIScale, ScreenGui.Scale.Scale = NewScale, NewScale
end

function redzlib:ResetConfig()
	redzlib.Save = {
		UISize = {550, 380},
		TabSize = 160,
		Theme = "Darker"
...
function redzlib:MakeWindow(Configs)
	...
	local MainCorner = Make("Corner", MainFrame, UDim.new(0, 15)) 
	...
	local ConfigButton = SetProps(CloseButton:Clone(), {
	...
	CloseButton.MouseEnter:Connect(function()
		CreateTween({CloseButton, "ImageColor3", Color3.fromRGB(255, 100, 100), 0.2})
	end)
	CloseButton.MouseLeave:Connect(function()
		CreateTween({CloseButton, "ImageColor3", Color3.fromRGB(255, 255, 255), 0.2})
	end)
	...
	MinimizeButton.MouseLeave:Connect(function()
		CreateTween({MinimizeButton, "ImageColor3", Color3.fromRGB(255, 255, 255), 0.2})
	end)
	
	ConfigButton.MouseEnter:Connect(function()
		CreateTween({ConfigButton, "ImageColor3", Theme["Color Theme"], 0.2})
	end)
	ConfigButton.MouseLeave:Connect(function()
		CreateTween({ConfigButton, "ImageColor3", Color3.fromRGB(255, 255, 255), 0.2})
	end)
...
function Window:MakeTab(paste, Configs)
	...
	local function Tabs()
		...
		CreateTween({Selected, "Size", UDim2.new(0, 4, 0, 15), 0.35})
	...
	function Tab:Enable()
		Tabs()
		CreateTween({TabSelect, "BackgroundTransparency", 0.3, 0.2})
	end
	...
	function Tab:AddButton(Configs)
		...
		FButton.MouseLeave:Connect(function()
			CreateTween({ButtonIcon, "Rotation", 0, 0.2})
		end)
		
		FButton.Activated:Connect(function()
			CreateTween({ButtonIcon, "Rotation", 90, 0.3})
			CreateTween({ButtonIcon, "Rotation", 0, 0.3, true})
	...
	function Tab:AddSlider(Configs)
		...
		SliderHolder.MouseButton1Down:Connect(function()
			...
			CreateTween({SliderIcon, "Size", UDim2.new(0, 8, 0, 14), 0.2})
	...
	function Tab:AddTextBox(Configs)
		...
		TextBoxInput.Focused:Connect(function()
			...
			CreateTween({SelectedFrame, "BackgroundColor3", Theme["Color Theme"], 0.2})
		end)
		TextBoxInput.FocusLost:Connect(function()
			CreateTween({SelectedFrame, "BackgroundColor3", Theme["Color Stroke"], 0.2})
		end)
	...
	function Tab:AddDiscordInvite(Configs)
		...
		JoinButton.MouseLeave:Connect(function()
			CreateTween({JoinButton, "BackgroundColor3", Color3.fromRGB(50, 150, 50), 0.2})
		end)
		...
		JoinButton.Activated:Connect(function()
			...
			ClickDelay = true
			CreateTween({JoinButton, "BackgroundColor3", Color3.fromRGB(100, 100, 100), 0.2})
			CreateTween({JoinButton, "TextColor3", Color3.fromRGB(150, 150, 150), 0.2})
			SetProps(JoinButton, {
				Text = "Copied to Clipboard",
			})
			task.wait(5)
			CreateTween({JoinButton, "BackgroundColor3", Color3.fromRGB(50, 150, 50), 0.2})
			CreateTween({JoinButton, "TextColor3", Color3.fromRGB(220, 220, 220), 0.2})
			SetProps(JoinButton, {
				Text = "Join",
			})
			ClickDelay = false
...
ConfigButton.Activated:Connect(function()
	...
	ConfigTab:AddDropdown({
		Title = "Theme",
		Options = {"Darker", "Dark", "Purple", "Red", "Green", "Orange", "Pink", "Cyan", "White", "Gold"},
	...
	ConfigTab:AddSection("Other Settings")
